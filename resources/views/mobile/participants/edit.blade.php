...
@section('content')
    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                {!! Form::model($participant, ['route' => ['mobile.participants.update', $participant->id], 'class' => 'body', 'role' => 'form', 'method' => 'put']) !!}
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="form-group">
                                <div class="form-line {{ $errors->has('birth_date') ? 'focused error' : '' }}">
                                    ...
                                    {!! Form::text('birth_date', format($participant->birth_date, 'd/m/Y'), ['class' => 'birth_date form-control', 'placeholder' => '99/99/9999']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
